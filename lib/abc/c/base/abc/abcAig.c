...
static void        Abc_AigReplace_int( Abc_Aig_t * pMan, Abc_Obj_t * pOld, Abc_Obj_t * pNew );
...
void Abc_AigReplace( Abc_Aig_t * pMan, Abc_Obj_t * pOld, Abc_Obj_t * pNew )
{
    ...
    while ( Vec_PtrSize(pMan->vStackReplaceOld) )
    {
        ...
        Abc_AigReplace_int( pMan, pOld, pNew );
    }
}
...
***********************************************************************/
void Abc_AigReplace_int( Abc_Aig_t * pMan, Abc_Obj_t * pOld, Abc_Obj_t * pNew )
{
    ...
    Vec_PtrForEachEntry( Abc_Obj_t *, pMan->vNodes, pFanout, k )
    {
        ...
        assert( !pFanout->fMarkA );
        // if the node is in the level structure, remove it
        assert( !pFanout->fMarkB );
