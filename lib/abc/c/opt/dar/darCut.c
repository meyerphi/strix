...
***********************************************************************/
static inline Dar_Cut_t * Dar_CutFindFree( Aig_Obj_t * pObj )
{
...
***********************************************************************/
static inline unsigned Dar_CutTruthShrink( unsigned uTruth, unsigned Phase )
{
    int i, k, Var = 0;
    for ( i = 0; i < 4; i++ )
        if ( Phase & (1 << i) )
...
static inline int Dar_CutSuppMinimize( Dar_Cut_t * pCut )
{
    ...
    uTruth = Dar_CutTruthShrink( uTruth, uPhase );
