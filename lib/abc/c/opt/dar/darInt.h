...
struct Dar_Man_t_
{
    ...
    Dar_Lib_t *      pDarLib;        // DAR lib manager
...
/*=== darCut.c ============================================================*/
extern void            Dar_ManCutsRestart( Dar_Man_t * p );
...
/*=== darLib.c ============================================================*/
extern void            Dar_LibEval( Dar_Man_t * p, Aig_Obj_t * pRoot, Dar_Cut_t * pCut, int * pnMffcSize );
extern Aig_Obj_t *     Dar_LibBuildBest( Dar_Man_t * p );
/*=== darMan.c ============================================================*/
extern Dar_Man_t *     Dar_ManStart( Dar_Lib_t * pDarLib, Aig_Man_t * pAig, Dar_RwrPar_t * pPars );
