...
***********************************************************************/
void Aig_NodeFixBufferFanins( Aig_Man_t * p, Aig_Obj_t * pObj )
{
...
int Aig_ManPropagateBuffers( Aig_Man_t * p )
{
    ...
    for ( nSteps = 0; Vec_PtrSize(p->vBufs) > 0; nSteps++ )
    {
        ...
        Aig_NodeFixBufferFanins( p, pObj );
...
***********************************************************************/
void Aig_ObjReplace( Aig_Man_t * p, Aig_Obj_t * pObjOld, Aig_Obj_t * pObjNew )
{
